...
public class FromHtmlConverter implements ToLatexConverter {
	...
	private ArrayList<String> tabulars;
	private int columns;
	private int lines;
	...
	public FromHtmlConverter() {
		columns = 0;
		lines = 0;
		tabulars = new ArrayList<String>();
		isFirstTableRow = true;
	}
	public String convert(String source) {
		replacedContent = new HashMap<String, String>();
	...
	private void addTeplateTebular() {
		String tabular="|";
	...
	private String replaceTabulars(String latexCode) {
		for (int i=0; i<tabulars.size(); i++) {
			if (latexCode.contains("#"))
				latexCode = replaceTebular(latexCode, tabulars.get(i));
		}
		return latexCode;
	}
	
	private String replaceTebular(String latexCode,String tebular) {
		return latexCode.replaceFirst("#", tebular);
	}
